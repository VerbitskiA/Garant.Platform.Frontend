...
@Component({
  selector: "app-edit-ready-business",
 ...
 */
export class EditReadyBusinessComponent implements OnInit {
  ...
  public onEditBusinessAsync() {
    ...
    this.http.post(API_URL.apiUrl.concat("/business/create-update-business"), sendFormData)
      .subscribe((response: any) => this.showMessageAfterSuccessCreateBusiness(), (err) => {
        this.commonService.routeToStart(err);
        throw new Error(err);
      });
  };
