...
export class BusinessNewsBlockComponent implements OnInit {
  ...
  readonly soringProperties: KeyValue<string, string> [] = [
    {key: 'byPopularUp', value: 'По популярности'},
    {key: 'byDateUp', value: 'По дате (сначала новые)'},
    {key: 'byDateDown', value: 'По дате (сначала старые)'}
  ];

  /** Модель формы */
  readonly businessNews = {
    form: null as unknown as FormGroup, model: {sorting: null}
  };
